...
//Serial.println(currentSeconds);
    int sensorValue1 = digitalRead(irSensorPin1); // Read the digital value from the IR sensor
    int sensorValue2 = digitalRead(irSensorPin2); // Read the digital value from the IR sensor
